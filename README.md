...
This repo consists of aditya verma youtube channel code for different section. This helps me keep track of java solutions instead of looking them up in different sources. 
...
5 | [Equal sum partition(subset sum & Knapsack Variation)]()| [:blue_book:](https://drive.google.com/file/d/1w3a8Xg8UzkeY6mStgnMkK9wnYRNVSBSB/view?usp=sharing)  | _O(N*W)_       | _O(N*W)_          |
6 | [Count of Subsets with given Sum(subset sum & Knapsack Variation)]()| [:blue_book:](https://drive.google.com/file/d/181rnNr7JfxWQgfxImbCnSuUEatCl1yZn/view?usp=sharing) | _O(N*W)_       | _O(N*W)_          |
